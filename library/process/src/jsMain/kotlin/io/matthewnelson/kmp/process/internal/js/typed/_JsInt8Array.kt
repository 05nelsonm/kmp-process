...
internal actual fun jsGet(array: JsInt8Array, index: Int): Byte = js(CODE_JS_ARRAY_GET)
@DoNotReferenceDirectly("array[index] = value")
internal actual fun jsSet(array: JsInt8Array, index: Int, value: Byte) { js(CODE_JS_ARRAY_SET) }
